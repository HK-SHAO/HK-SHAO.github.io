...
- 在线效果演示 [shao.fun/RayTracingPBR/](https://shao.fun/RayTracingPBR/), [shadertoy.com/view/Dtj3DG](https://www.shadertoy.com/view/Dtj3DG)
...
在虚拟的三维空间里定义摄像机位置之前，还差一个 z 轴正方向：uv 坐标已经建立了二维坐标系。用过三维软件或游戏引擎的话会知道，图形学常用左手系。
...
实现最基本的材质：漫反射。表面粗糙的石头就是漫反射，光线在物体表面随机反射，没有明显的反射方向。思路是半球采样：在物体表面某点，以法线为 z 轴，在表面外的单位半球上随机取一点作为出射光方向。
