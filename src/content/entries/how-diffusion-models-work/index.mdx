---
title: 扩散模型是如何工作的
description: 从数学原理出发，推一遍去噪扩散概率模型的前向与反向过程。
publishedAt: 2022-10-28
updatedAt: 2022-12-12
tags: [Diffusion, Machine Learning, Math]
commentTerm: blog/w/how-diffusion-models-work
---
...
![diffusion-models.png](./media/diffusion-models.webp)
...
![forward-diffusion.png](./media/forward-diffusion.webp)
...
![variance-schedule.png](./media/variance-schedule.webp)
...
![reverse-diffusion.png](./media/reverse-diffusion.webp)
...
![training-sampling-ddpm.png](./media/training-sampling-ddpm.webp)
...
![classifier-guidance.png](./media/classifier-guidance.webp)
...
[Saharia et al.](https://arxiv.org/abs/2205.11487) 提出的 Imagen 在很大程度上依赖于无分类器的引导，因为他们发现这是一个关键因素去产生具有强大图像-文本对准的生成样本。关于 Imagen 方法的更多信息，见 AI Coffee Break 与 Letitia 的[这段视频](https://www.youtube.com/watch?v=xqDeAz0U-R4)。
...
![cascade-diffusion.png](./media/cascade-diffusion.webp)
...
![stable-diffusion.png](./media/stable-diffusion.webp)
...
欲了解更多信息，见[这个视频](https://www.youtube.com/watch?v=ltLNYA3lWAQ)。
...
![score-based.png](./media/score-based.webp)
...
![score-sde.png](./media/score-sde.webp)
...
![score-based-sde-overview.png](./media/score-based-sde-overview.webp)
