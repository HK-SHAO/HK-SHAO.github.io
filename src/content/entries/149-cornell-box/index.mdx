---
title: 149 行代码的康奈尔盒子
description: 用 149 行 Taichi 代码渲染出经典的康奈尔盒子。
publishedAt: 2023-01-20
updatedAt: 2023-01-30
tags: [Taichi, Ray Tracing, SDF]
---

import Callout from "../../../components/mdx/Callout.astro";

|![Cornell Box Blender](./media/cornell_box_blender.webp)|![Cornell Box Taichi](./media/cornell_box_taichi.webp)|
|:-:|:-:|
