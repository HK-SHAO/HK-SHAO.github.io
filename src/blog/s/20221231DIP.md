...
摄像机是对人眼的模仿，但现实的摄像机拥有更多可以调整的参数，例如摄像机除了有位置 (lookfrom) 、朝向 (lookat,vup) 之外，还有视野 (vfov)、传感器（画布）长宽比 (aspect)、光圈直径 (aperture)、合焦距离 (focus) 等等参数，这些参数会影响摄像机传感器捕获的光子。关于摄像机的更多信息，可以看我为 Taichi 写的这篇科普文章：[Taichi: 从零开始的光线追踪 | HK-SHAO](https://shao.fun/blog/w/taichi-ray-tracing.html#%E5%88%9B%E5%BB%BA%E6%91%84%E5%83%8F%E6%9C%BA%E7%B1%BB)
